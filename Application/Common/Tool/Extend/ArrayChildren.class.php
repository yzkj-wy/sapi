...
class ArrayChildren
{
    ...
    {
        if (!is_array($beCompared)) {
            throw "参数必须是数组";
        }
        return array_merge(array_diff($this->data, $beCompared),array_diff($beCompared, $this->data));
    }
     ...
     * @return array
     */
    public function parseArrayByArbitrarily($key)
    {
        $array = $this->data;
     ...
     */
    public function isSameValueByArray ()
    {
